...
def download_upvotes(username: str, hn_user_cookie: str):
    upvotes = []
    parse = lambda d: dict(
...
diwank_upvotes = download_upvotes("diwank", "diwank&T34GrulnAWZaHDBCE3DjjBZj7Plb8Gg9")
